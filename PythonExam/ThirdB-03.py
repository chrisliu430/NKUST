...
#While previous number is bigger than behind number that Stopping this execute
#When previous number is less than behind number
...
while(1):
	...
	if (ipt[0] >= ipt[1]):
		...
		for i in range (ipt[0],ipt[1]+1):
			for j in range (ipt[1]-i):
				print(" ",end = "")
